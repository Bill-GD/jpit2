...
(1, 1, 'chào', 'こんにちは', 'lesson_3/hi.mp3', now(), now()),
(2, 1, 'xin lỗi', 'すみません', 'lesson_3/sorry.mp3', now(), now()),
(3, 1, 'tên', '名前', 'lesson_3/name.mp3', now(), now()),
(4, 1, 'người', '人、～人', 'lesson_3/people.mp3', now(), now()),
(5, 1, 'nước', '国', 'lesson_3/country.mp3', now(), now()),
(6, 1, 'nào', 'どの', 'lesson_3/which.mp3', now(), now()),
(7, 1, 'là', '～です', 'lesson_3/is.mp3', now(), now()),
(8, 1, 'rất', 'とても', 'lesson_3/very.mp3', now(), now()),
(9, 1, 'vui', '嬉しい', 'lesson_3/happy.mp3', now(), now()),
(10, 1, 'gặp', '会う', 'lesson_3/meet.mp3', now(), now()),
(11, 1, 'rất vui được gặp', 'お会いできて嬉しい', 'lesson_3/happy_to_meet.mp3', now(), now());
