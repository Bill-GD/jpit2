            ...
            <div class="col text-decoration-none text-center">
                <div class="row border border-dark-subtle rounded-1 mx-1 my-2 pt-4 px-3">
                    ...
                    <div class="col-2 flex align-content-center">
                        <p class="">dasda</p>
                        <p class="">dasda</p>
                        <a class="text-decoration-none icon-link icon-link-hover fs-3 mt-3 fa-solid fa-volume-high" id="play_sound" href="#"></a>
                    </div>
                </div>
            </div>
            <div class="col text-decoration-none text-center">
            ...
            <div class="col text-decoration-none text-center">
                <div class="row border border-dark-subtle rounded-1 mx-1 my-2 pt-4 px-3">
                    ...
                    <div class="col-2 flex align-content-center">
                        <p class="">dasda</p>
                        <p class="">dasda</p>
                        <a class="text-decoration-none icon-link icon-link-hover fs-3 mt-3 fa-solid fa-volume-high" id="play_sound" path="" href="#"></a>
                    </div>
                </div>
            </div>
        </div>
